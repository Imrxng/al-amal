...
const Map = () => {
  ...
  return (
    <MapContainer center={[51.2206093675261, 4.4592743]} zoom={14} scrollWheelZoom={false} style={{ height: "500px", backgroundColor: '#f9f9f9', marginTop: '20rem',borderRadius: '10px'}}>
      <TileLayer
